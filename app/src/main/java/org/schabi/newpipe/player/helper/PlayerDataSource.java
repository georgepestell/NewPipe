...
public class PlayerDataSource {
    ...
    public PlayerDataSource(final Context context,
        ...
        // Generic data source factories use OkHttpDataSource.Factory, backed by the same
        // OkHttpClient as the extractor. This makes them honour the user's IPv4/IPv6 preference
        // (via the custom Dns set on that client) for all non-YouTube streams.
